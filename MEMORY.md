# LinkedIn Hub Driver Memory
## Scope
- Package role: Normalization (Drivers)
- Purpose: This package operates within the Normalization (Drivers) layer of the APIs Hub SaaS hierarchy, providing data normalization for the LinkedIn ecosystem.
...
## Current notes
- LinkedIn driver currently has no dedicated SDK package and relies on the core abstraction stack.